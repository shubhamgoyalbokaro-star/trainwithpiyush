        ...
        <div className="space-y-16">
          {site.programs.map((program, i) => (
            <article
              key={program.id}
              id={program.id}
              className="scroll-mt-24 rounded-3xl border border-border bg-card overflow-hidden"
            >
              <div className="grid lg:grid-cols-5">
                <div className="lg:col-span-2 bg-accent/5 p-10 flex flex-col justify-center border-b lg:border-b-0 lg:border-r border-border">
                  ...
                  <p className="mt-6 text-2xl font-display font-bold text-accent">{program.pricing}</p>
                </div>
                        ...
                        <dd className="mt-1 font-medium">
                          {label === "Location" && value !== "Worldwide" ? (
                            <a
                              ...
                              className="group inline-flex items-start gap-1.5 text-accent transition hover:underline"
                            >
